...
from autolemetry import init, span, trace, track
...
def test_functional_example() -> None:
    ...
    from autolemetry import instrument, with_new_context
...
def test_events_example() -> None:
    ...
    from autolemetry.subscribers import EventSubscriber
...
def main() -> None:
    ...
    print("=" * 60)
    print("Testing autolemetry examples")
    print("=" * 60 + "\n")
