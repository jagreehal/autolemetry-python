"""Graceful shutdown for autolemetry."""
...
async def shutdown(timeout: float = 5.0) -> None:
    """
    Gracefully shutdown autolemetry.
    ...
    if _shutdown_complete:
        logger.info("autolemetry shutdown skipped (already completed)")
        return
    ...
    logger.info("autolemetry shutdown complete")
