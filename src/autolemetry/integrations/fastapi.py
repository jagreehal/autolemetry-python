"""FastAPI integration for autolemetry."""
...
class AutolemetryMiddleware(BaseHTTPMiddleware):
    """
    ...
    def __init__(
        ...
        **init_kwargs: Any,
        ...
        """
        Initialize autolemetry middleware.
        ...
        """
        super().__init__(app)
        # Initialize autolemetry only once to preserve existing span processors in tests/apps
        try:
            import importlib

            init_state = importlib.import_module("autolemetry.init")
