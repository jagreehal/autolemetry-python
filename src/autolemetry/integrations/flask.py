"""Flask integration for autolemetry."""
...
def init_autolemetry(
    ...
    **init_kwargs: Any,
    ...
    """
    Initialize autolemetry for Flask application.
    ...
    Args:
        ...
        **init_kwargs: Additional arguments passed to autolemetry.init()
    """
    global _INITIALIZED
    if not _INITIALIZED:
    ...
    def before_request() -> None:
        ...
        g.autolemetry_span = span
        g.autolemetry_start_time = time.time()

    @app.after_request
    def after_request(response: Any) -> Any:
        """End trace span after request."""
        if hasattr(g, "autolemetry_span"):
            span = g.autolemetry_span
            start_time = g.autolemetry_start_time
    ...
    def teardown_request(exception: Any) -> None:
        """Handle exceptions."""
        if exception and hasattr(g, "autolemetry_span"):
            from opentelemetry import trace
