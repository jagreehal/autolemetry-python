...
def set_attributes(attributes: dict[str, Any]) -> None:
    ...
    Example:
        >>> from autolemetry import set_attributes
        >>> set_attributes({
        ...     "user.id": "123",
        ...     "user.role": "admin",
        ...     "request.size": 1024
...
def set_attribute(key: str, value: Any) -> None:
    ...
    Example:
        >>> from autolemetry import set_attribute
...
def add_event(name: str, attributes: dict[str, Any] | None = None) -> None:
    ...
    Example:
        >>> from autolemetry import add_event
...
def record_exception(exception: Exception, attributes: dict[str, Any] | None = None) -> None:
    ...
    Example:
        >>> from autolemetry import record_exception
        >>> try:
        ...     risky_operation()
...
def get_trace_id() -> str | None:
    ...
    Example:
        >>> from autolemetry import get_trace_id
...
def get_span_id() -> str | None:
    ...
    Example:
        >>> from autolemetry import get_span_id
        >>> span_id = get_span_id()
...
def get_baggage(key: str) -> str | None:
    ...
    Example:
        >>> from autolemetry import get_baggage
...
def get_all_baggage() -> dict[str, str]:
    ...
    Example:
        >>> from autolemetry import get_all_baggage
...
def set_baggage_value(key: str, value: str) -> otel_context.Token[Any]:
    ...
    Example:
        >>> from autolemetry import set_baggage_value
