...
### Fixed
- Fixed GitHub Actions workflow to properly run tests across Python 3.10-3.13
...
- Ergonomic `@trace` decorator for sync and async functions
...
- Adaptive sampler (configurable baseline, error, and slow operation rates)
- Token bucket rate limiter
- Circuit breaker for subscriber protection
- Queue-based event system with graceful degradation
- Serverless environment detection and auto-flush
...
[0.1.0]: https://github.com/jagreehal/autolemetry-python/releases/tag/v0.1.0
