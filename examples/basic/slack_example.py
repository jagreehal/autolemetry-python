...
from autolemetry.subscribers import SlackSubscriber


class MockSlackSubscriber(SlackSubscriber):
    """Mock Slack subscriber that prints messages instead of sending to Slack."""

    def __init__(self, channel: str = "#alerts", username: str = "autolemetry"):
...
# Initialize autolemetry with Slack subscriber
init(
