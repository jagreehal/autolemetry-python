...
This example demonstrates how to use Autolemetry's semantic convention helpers
...
from autolemetry import init, trace_db, trace_http, trace_llm, trace_messaging

# Initialize Autolemetry with console exporter for demonstration
...
async def get_github_user(ctx, username: str) -> None:
    ...
    ctx.set_attribute("http.request.header.user_agent", "autolemetry-demo/1.0")
