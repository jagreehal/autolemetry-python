# Autolemetry: Boilerplate Elimination Comparison

This directory contains real-world examples showing how autolemetry eliminates observability boilerplate.

## 📊 The Numbers

| Metric | Before (Manual OTEL) | After (Autolemetry) | Reduction |
|--------|---------------------|---------------------|-----------|
...
### Before: Manual OpenTelemetry (`before_autolemetry.py`)
...
### After: Autolemetry (`after_autolemetry.py`)

**Benefits:**
- **3-5 lines** of setup
- **1 import statement**: `import autolemetry`
...
### After: Autolemetry (`context_propagation_after.py`)
...
| Aspect | Manual OTEL | Autolemetry |
|--------|-------------|-------------|
...
# AFTER: 1 line
autolemetry.init(service_name="my-service")
```
...
# AFTER: 0 lines
result = do_work()  # Autolemetry handles it via framework instrumentation
```
...
# AFTER: Automatic
# Autolemetry automatically creates and records HTTP metrics
```
