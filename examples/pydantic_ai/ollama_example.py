"""Pydantic AI example with Ollama and Llama3.2, integrated with autolemetry."""
...
from autolemetry import ConsoleSpanExporter, SimpleSpanProcessor, init, trace
...
async def extract_user_profile(ctx, text: str) -> UserProfile:
    ...
    This function is automatically traced by autolemetry.
    """
...
async def main() -> None:
    """Main function demonstrating Pydantic AI with autolemetry."""
    print("=== Pydantic AI + autolemetry Example ===\n")
