# Pydantic AI + autolemetry Example

This example demonstrates how to use Pydantic AI with Ollama and Llama3.2, integrated with autolemetry for automatic tracing.
...
pip install autolemetry pydantic-ai ollama
```
