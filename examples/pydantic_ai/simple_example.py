"""Simple Pydantic AI example with autolemetry - minimal setup."""
...
# Initialize autolemetry (one line!)
init(
...
async def ask_ai(ctx, question: str) -> str:
    ...
    Automatically traced by autolemetry!
    """
...
async def main() -> None:
    """Simple example."""
    print("=== Simple Pydantic AI + autolemetry ===\n")
