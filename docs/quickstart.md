...
Get started with autolemetry in under 5 minutes.
...
pip install autolemetry[fastapi]

# With all features
pip install autolemetry[all]
```
...
```python
from autolemetry import trace_llm, trace_db, trace_http
